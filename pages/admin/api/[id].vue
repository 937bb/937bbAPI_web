<template>
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form v-else class="space-y-6 divide-y divide-gray-200" @submit.prevent="submitEdit">
      <div class="space-y-6 sm:space-y-5">
              ...
              <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div class="sm:col-span-4">
                  ...
                  <p class="mt-2 text-sm text-gray-500">
                    请以斜杠 <code class="bg-gray-100 px-1 py-0.5 rounded">/</code> 开头的路径，例如 <code class="bg-gray-100 px-1 py-0.5 rounded">/api/user</code>
                  </p>
                </div>
                <!-- 完整API地址展示 -->
                  ...
                  <div class="mt-1">
                    <div class="flex rounded-md shadow-sm">
                      ...
                      <div class="flex-1 min-w-0">
                        <div class="flex rounded-md shadow-sm">
                          <span class="inline-flex items-center px-3 rounded-none border border-r-0 border-gray-300 bg-gray-50 text-gray-500 text-sm truncate">
                            {{ apiBase }}
                          </span>
                          <input
                            type="text"
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
          <div class="px-4 py-5 sm:px-6 bg-gray-50">
            <h3 class="text-lg leading-6 font-medium text-gray-900">请求响应示例</h3>
          </div>
          <div class="px-4 py-5 sm:p-6">
            <div class="grid grid-cols-1 gap-6">
              <!-- 请求参数示例 -->
              <div>
                <label for="requestExample" class="block text-sm font-medium text-gray-700 mb-2">
                  请求参数示例
                </label>
                <div class="rounded-md shadow-sm">
                  <div class="flex justify-between items-center bg-gray-50 px-3 py-2 border border-b-0 border-gray-300 rounded-t-md">
              ...
              <!-- 返回示例 -->
              <div>
                <label for="responseExample" class="block text-sm font-medium text-gray-700 mb-2">
                  返回示例
                </label>
                <div class="rounded-md shadow-sm">
                  <div class="flex justify-between items-center bg-gray-50 px-3 py-2 border border-b-0 border-gray-300 rounded-t-md">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
          <div class="px-4 py-5 sm:px-6 bg-gray-50 border-b border-gray-200">
            <div class="flex justify-between items-center">
              <h3 class="text-lg leading-6 font-medium text-gray-900">请求参数描述</h3>
              <button
                type="button"
                @click="
          ...
          <div class="px-4 py-5 sm:p-6">
            <div v-if="form.requestParams.length === 0" class="text-center py-4 text-sm text-gray-500">
              暂无请求参数，点击右上角"添加参数"按钮添加
            </div>
            <div v-else class="space-y-4">
              <div v-for="(param, idx) in form.requestParams" :key="idx" class="bg-gray-50 p-4 rounded-lg border border-gray-200">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
          <div class="px-4 py-5 sm:px-6 bg-gray-50 border-b border-gray-200">
            <div class="flex justify-between items-center">
              <h3 class="text-lg leading-6 font-medium text-gray-900">返回数据描述</h3>
              <button
                type="button"
                @click="form.responseStatus.push({ name: '', type: 'string', meaning: '', description: '' })"
          ...
          <div class="px-4 py-5 sm:p-6">
            <div v-if="form.responseStatus.length === 0" class="text-center py-4 text-sm text-gray-500">
              暂无返回字段，点击右上角"添加字段"按钮添加
            </div>
            <div v-else class="space-y-4">
              <div v-for="(field, idx) in form.responseStatus" :key="idx" class="bg-green-50 p-4 rounded-lg border border-green-200">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-12">
                  <div class="sm:col-span-3">
                  ...
                  <div class="sm:col-span-3">
                    <label class="block text-sm font-medium text-gray-700 mb-1">含义</label>
                    <input
        ...
        <div class="pt-5">
          <div class="flex justify-end space-x-3">
            <NuxtLink to="/admin/api" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
              取消
            </NuxtLink>
            <button
              type="submit"
