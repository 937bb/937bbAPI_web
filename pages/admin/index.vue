	...
	<div class="w-full px-4 py-4 sm:px-6 lg:px-8">
		...
		<div class="max-w-7xl mx-auto ">
			...
			<div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
				...
				<div class="bg-white overflow-hidden shadow rounded-xl transition-all duration-200 hover:shadow-lg">
					...
					<div class="bg-gray-50 px-5 py-3">
						<div class="text-sm">
							<NuxtLink to="/admin/api" class="font-medium text-blue-600 hover:text-blue-500"> 查看所有 API </NuxtLink>
						</div>
					</div>
				</div>
				...
				<div class="bg-white overflow-hidden shadow rounded-xl transition-all duration-200 hover:shadow-lg">
					...
					<div class="bg-gray-50 px-5 py-3">
						<div class="text-sm">
							<NuxtLink to="/admin/users" class="font-medium text-green-600 hover:text-green-500"> 查看所有用户 </NuxtLink>
						</div>
					</div>
				</div>
						...
						<li v-for="(activity, index) in recentActivities" :key="index" class="px-6 py-4">
							<div class="flex items-center">
								...
								<div class="ml-4">
									...
									<p class="text-sm text-gray-500">{{ activity.timestamp }} · {{ activity.details }}</p>
								</div>
							</div>
						</li>
						<li v-if="recentActivities.length === 0" class="px-6 py-4 text-center text-gray-500">暂无活动记录</li>
					</ul>
				</div>
			</div>
			...
			<div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
				<NuxtLink
					to="/admin/api/new"
					class="relative bg-white p-6 border border-gray-200 rounded-xl shadow-sm flex items-center space-x-4 hover:border-blue-500 hover:shadow-md focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500 transition-all duration-200"
				>
				...
				<NuxtLink
					to="/admin/api"
					class="relative bg-white p-6 border border-gray-200 rounded-xl shadow-sm flex items-center space-x-4 hover:border-green-500 hover:shadow-md focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-green-500 transition-all duration-200"
				>
				...
				<NuxtLink
					to="/admin/users"
					class="relative bg-white p-6 border border-gray-200 rounded-xl shadow-sm flex items-center space-x-4 hover:border-purple-500 hover:shadow-md focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-purple-500 transition-all duration-200"
				>
				...
				<NuxtLink
					to="/admin/settings"
					class="relative bg-white p-6 border border-gray-200 rounded-xl shadow-sm flex items-center space-x-4 hover:border-yellow-500 hover:shadow-md focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-yellow-500 transition-all duration-200"
				>
