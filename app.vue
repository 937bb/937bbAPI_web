<template>
  <div class="min-h-screen flex flex-col bg-[#f8fafc]">
    ...
    <!-- <footer class="bg-white border-t border-gray-100">
      <div class="max-w-7xl mx-auto py-6 px-4 text-center text-gray-400 text-xs">
        <span v-if="icp && icp.length > 0">
          备案号：<a :href="icpUrl" target="_blank" class="hover:text-blue-600 transition-colors duration-200">{{ icp }}</a>
        </span>
        <span v-else>
          &copy; 2025 {{ siteName }}
        </span>
